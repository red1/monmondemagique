...
const styles = StyleSheet.create({
  ...
  tabs: { flexDirection: 'row', backgroundColor: 'rgba(0,0,0,0.05)', borderRadius: 25, padding: 5, marginBottom: 20 },
  ...
  tabText: { fontFamily: 'Fredoka-SemiBold', fontSize: 14, color: '#666' },
  activeTabText: { color: '#FF6347' },
  jokeCard: { width: '100%', backgroundColor: 'white', borderRadius: 30, padding: 20, elevation: 5, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 8, minHeight: 250, justifyContent: 'center' },
  cardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', position: 'absolute', top: 15, left: 20, right: 20 },
  speakBtn: { padding: 5 },
  questionText: { fontFamily: 'Fredoka-SemiBold', fontSize: 20, textAlign: 'center', color: '#333', marginTop: 30, marginBottom: 20 },
  answerContainer: { backgroundColor: '#F0F8FF', borderRadius: 20, padding: 15, minHeight: 80, justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderStyle: 'dashed', borderColor: '#00CED1' },
  answerHidden: { backgroundColor: '#FFF5E1', borderColor: '#FFD700' },
  answerText: { fontFamily: 'Fredoka-SemiBold', fontSize: 18, textAlign: 'center', color: '#FF6347' },
  tapToSee: { fontFamily: 'Fredoka-SemiBold', fontSize: 16, textAlign: 'center', color: '#B8860B', fontStyle: 'italic' },
  nextBtn: { marginTop: 20, width: width * 0.5, height: 50, borderRadius: 30, overflow: 'hidden', elevation: 3 },
