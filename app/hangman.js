...
import { View, Text, StyleSheet, TouchableOpacity, Modal, SafeAreaView, Dimensions, TextInput, Keyboard } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  hangmanContainer: { width: 180, height: 220, marginBottom: 20, position: 'relative' },
  base: { position: 'absolute', bottom: 0, width: 100, height: 10, backgroundColor: '#5D4037', left: 40, borderRadius: 5 },
  pole: { position: 'absolute', bottom: 10, left: 60, width: 10, height: 180, backgroundColor: '#5D4037', borderRadius: 5 },
  topBar: { position: 'absolute', top: 30, left: 60, width: 80, height: 10, backgroundColor: '#5D4037', borderRadius: 5 },
  rope: { position: 'absolute', top: 40, left: 125, width: 4, height: 25, backgroundColor: '#8D6E63' },
  head: { position: 'absolute', top: 65, left: 110, width: 30, height: 30, borderRadius: 15, borderWidth: 4, borderColor: '#333' },
  body: { position: 'absolute', top: 95, left: 125, width: 4, height: 50, backgroundColor: '#333' },
  armLeft: { position: 'absolute', top: 100, left: 105, width: 20, height: 4, backgroundColor: '#333', transform: [{ rotate: '-30deg' }] },
  armRight: { position: 'absolute', top: 100, left: 130, width: 20, height: 4, backgroundColor: '#333', transform: [{ rotate: '30deg' }] },
  legLeft: { position: 'absolute', top: 145, left: 110, width: 20, height: 4, backgroundColor: '#333', transform: [{ rotate: '-45deg' }] },
  legRight: { position: 'absolute', top: 145, left: 125, width: 20, height: 4, backgroundColor: '#333', transform: [{ rotate: '45deg' }] },
  wordDisplay: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', gap: 8 },
  letterSlot: { width: 30, alignItems: 'center' },
  letterText: { fontSize: 28, fontFamily: 'Fredoka-SemiBold', color: '#333', fontWeight: 'bold' },
  ...
  key: { width: KEY_WIDTH * 0.9, height: 45, backgroundColor: 'white', borderRadius: 10, justifyContent: 'center', alignItems: 'center', elevation: 3, borderBottomWidth: 4, borderBottomColor: '#ddd' },
  ...
  keyText: { fontSize: 20, fontFamily: 'Fredoka-SemiBold', color: '#333', fontWeight: 'bold' },
